...
def ensure_config_persisted() -> None:
    """
    ✅ Para que al hacer deploy no vuelva a manual/low si el archivo no existe.
    Si no existe el archivo aún, guarda defaults auto/medium.
    """
    try:
